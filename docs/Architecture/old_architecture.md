...
>
> **ห้ามใช้ไฟล์นี้เป็นสเปกในการเขียนโค้ด** — ฉบับที่ใช้จริงคือ [`docs/Architecture/architecture.md`](architecture.md)
>
...
> กู้ฉบับดิบได้ด้วย: `git show eea5647 > docs/Architecture/old_architecture.md`
