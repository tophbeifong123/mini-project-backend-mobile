...
> จังหวะ "ทุก 3 วินาที" มาจาก **JavaScript ในหน้าเว็บที่ poll เอง** (`insights.page.ts:418`) ปิดแท็บเมื่อไหร่ก็หยุดยิง query ทันที — จงใจ เพื่อไม่ให้มี query วิ่งกินทรัพยากรอยู่เบื้องหลังตลอดเวลาที่ยิง k6
